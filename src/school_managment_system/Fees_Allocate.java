 ...
 */
public class Fees_Allocate extends javax.swing.JFrame {

    /**
     * Creates new form Fees_Allocate
     */
    String year;
    Database db;
    CallableStatement mystmt;
    public Fees_Allocate() {
        db=new Database();
        mystmt=null;
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox_Y.setBackground(new java.awt.Color(108, 122, 137));
        jComboBox_Y.setEditable(true);
        jComboBox_Y.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        jComboBox_Y.setForeground(new java.awt.Color(236, 240, 241));
        jComboBox_Y.setMaximumRowCount(4);
        jComboBox_Y.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select", "2019/2020", "2020/2021", "2021/2022", "2022/2023", "2023/2024", "2024/2025", "2025/2026", "2026/2027", "2027/2028", "2028/2029", "2029/2030" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jComboBox_Y, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jComboBox_Y, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(39, 39, 39)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jLabelLogin.setText("Fees Allocation");
    ...
    private void jButtonPromoteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPromoteActionPerformed
        try {
            mystmt=db.con.prepareCall("{call fees_allocate(?)}");
            mystmt.setString(1,jComboBox_Y.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fees_Allocate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fees_Allocate().setVisible(true);
            }
        });
    }
