 ...
 */
public class New_Addmission extends javax.swing.JFrame {

    /**
     * Creates new form New_Addmission
     */
    String firstName;
    String lastName;
    String gender;
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(jTextFieldFatherName, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void jButtonConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmActionPerformed
        ...
        if(firstName.length() !=0 && lastName.length() !=0 && gender.length() !=0 && fatherName.length() !=0 && contact.length() !=0  && cnic.length()
           !=0 && class_id.length() !=0 && !(dob.equals("null-null-null")) && address.length() !=0){
            try {
                mystmt=db.con.prepareCall("{call student_enrollment(?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
                ...
                mystmt.registerOutParameter(14,Types.INTEGER);
                boolean hasresult=mystmt.execute();
                if(!hasresult){
                    int s_id=mystmt.getInt(13);
                    int p_id=mystmt.getInt(14);
                ...
                /*sql="INSERT INTO parent(name,cnic,contact,email,address) Values('"+fatherName+"','"+cnic+"','"+contact+"','"+email+"','"+address+"')";
        
                int n=db.stmt.executeUpdate(sql);
                if(n==1){
                    db.rs = db.stmt.executeQuery("SELECT parent_id FROM parent ORDER BY parent_id DESC LIMIT 1");
                    db.rs.next();
                    int p_id=db.rs.getInt("parent_id");
                    JOptionPane.showMessageDialog(this, " Parent Data Saved Successfully  "+p_id);
                    sql="INSERT INTO students(first_name,last_name,p_id,gender,birth_date,last_school,class_Addm) Values('"+firstName+"','"+lastName
                            +"','"+p_id+"','"+gender+"','"+dob+"','"+lastSchool+"','"+class_id+"')";
                    n=db.stmt.executeUpdate(sql);
                    if(n==1){
                       JOptionPane.showMessageDialog(this, " Student Data Saved Successfully  "+p_id);    
                    }
                    else{
                        JOptionPane.showMessageDialog(this," Student Data not saved ","Try Again",JOptionPane.WARNING_MESSAGE);
                    }
                    ...
                    JOptionPane.showMessageDialog(this,"Parent Data not saved","Try Again",JOptionPane.WARNING_MESSAGE);
                }*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(New_Addmission.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new New_Addmission().setVisible(true);
        });
    }
