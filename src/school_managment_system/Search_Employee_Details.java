...
public class Search_Employee_Details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelUsername.setText("Employee ID:");
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        e_id=Integer.parseInt(jTextField_Id.getText());
        boolean check=false;
        try {
            db.rs=db.stmt.executeQuery("SELECT id FROM employees");
            while(db.rs.next()){
                if(e_id==db.rs.getInt("id")){
                    check=true;
                    break;
                }
            }
            if(check){
                ...
                JOptionPane.showMessageDialog(this, "Employee with id="+e_id+" does not exists");
                Search_Employee_Details ssd;
                ssd = new Search_Employee_Details();
                ssd.setVisible(true);
                ssd.pack();
